...
if (empty($title) && empty($description)) {
    echo '<span style="color:red;">Both title and description are needed</span>';
} elseif (empty($title)) {
    echo '<span style="color:red;">Title is needed</span>';
} elseif (empty($description)) {
    echo '<span style="color:red;">Description is needed</span>';
}
?>
...
<!-- ?php if (empty($description)) {
    ...
    elseif (empty($title)) {
        echo '<span style="color:red;">Title is needed</span>';}
            ...
            echo '<span style="color:red;">Description is needed <br> Title is needed</span>';
        } 
        ?>
