...
return array_filter($listings, function($job) use ($location){//access to jobs
  return strcasecmp($job['location'], $location) === 0; //case non-sensitive.
});
}

//check if location query string is available
          ...
          <div class="p-4">
            ...
            <ul class="mt-4">
              ...
              <li class="mb-2">
                ...
                <span class="text-xs text-white <?= $job['location'] === 'Tutong' ? 'bg-blue-500' : 'bg-green-500'; ?> rounded-full px-2 py-1 ml-2"><?= $job['location'] === 'Tutong' ? 'Local' : 'Remote'; ?></span>
              </li>
