...
<?php foreach ($listings as $jobless) : ?>
    <div class="md my-4">
        <div class="bg-white rounded-lg shadow-md">
            <div class="p-4">
                <h2 class="text-xl font-semibold"><?= $jobless['title'] ?></h2>
                <p class="text-gray-700 text-lg mt-2"><?= $jobless['description'] ?></p>
                <ul class="mt-4">
                    <li class="mb-2">
                        <strong>Salary:</strong> $<?= $jobless['salary'] ?>
                    </li>
                    <li class="mb-2">
                        <strong>Location:</strong> <?= $jobless['location'] ?>
                    </li>
                    <li class="mb-2">
                        <strong>Tags:</strong> <?= implode(', ', $jobless['tags']) ?>
                    </li>
                </ul>
            </div>
        </div>
